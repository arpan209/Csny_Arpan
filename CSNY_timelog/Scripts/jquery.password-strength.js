...
(function($) {
    ...
    $.fn.password_strength = function(options) {
        ...
        $.ajax({
            type: "GET",
            url: '@Url.Content("~/xml/PasswordPolicy.xml")',  //use absolute link if possible
            dataType: "xml",
        ...
        return this.each(function() {
            ...
            .css({ position: 'absolute', top: barTopPos - 6, left: barLeftPos + 15, 'font-size': '75%', display: 'inline-block', width: password_settings.barWidth - 60 });
            ...
            $(this).keyup(function() {
                ...
                if (passwordVal.length > 0) {
                    ...
                    $("[id='PasswordStrengthBorder']").css({ display: 'inline', width: barWidth -60});
                    ...
                    $("[id='PasswordStrengthBar']").css({ display: 'inline', width: strengthPercent-55, 'background-color': backColor });
